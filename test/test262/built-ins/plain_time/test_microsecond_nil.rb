...
module Temporal::TestPlainTime
  class Constructor < Minitest::Test
    def test_explicit_nil_microsecond
      plain_time = Temporal::PlainTime.new(12, 34, 56, 123)

      assert_plain_time(plain_time, 12, 34, 56, 123, 0, 0, "explicit")
    end

    def test_implicit_nil_microsecond
      plain_time = Temporal::PlainTime.new(12, 34, 56, 123)

      assert_plain_time(plain_time, 12, 34, 56, 123, 0, 0, "implicit")
    end
  end
end
