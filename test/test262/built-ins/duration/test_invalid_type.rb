  ...
  class Constructor < Minitest::Test
    {
      ...
      define_method "test_invalid_#{name}" do
        assert_raises(TypeError) { Temporal::Duration.new(invalid) }
        assert_raises(TypeError) { Temporal::Duration.new(0, invalid) }
        assert_raises(TypeError) { Temporal::Duration.new(0, 0, invalid) }
        assert_raises(TypeError) { Temporal::Duration.new(0, 0, 0, invalid) }
        assert_raises(TypeError) { Temporal::Duration.new(0, 0, 0, 0, invalid) }
        assert_raises(TypeError) { Temporal::Duration.new(0, 0, 0, 0, 0, invalid) }
        assert_raises(TypeError) { Temporal::Duration.new(0, 0, 0, 0, 0, 0, invalid) }
        assert_raises(TypeError) { Temporal::Duration.new(0, 0, 0, 0, 0, 0, 0, invalid) }
        assert_raises(TypeError) { Temporal::Duration.new(0, 0, 0, 0, 0, 0, 0, 0, invalid) }
        assert_raises(TypeError) { Temporal::Duration.new(0, 0, 0, 0, 0, 0, 0, 0, 0, invalid) }
      end
    end
  end
end
